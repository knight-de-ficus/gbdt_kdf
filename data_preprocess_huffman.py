...
if __name__ == "__main__":
    ...
    training_features, training_labels, test_features, test_labels, label_mapping = preprocess_data(training_data, test_data, mode="one-hot",lable_index=-2)

    training_data = pd.concat([training_features, training_labels], axis=1)
    training_data.to_csv("./data_2/kddtrain_onehot.csv", index=False)
    training_data = pd.concat([ test_features, test_labels], axis=1)
    training_data.to_csv("./data_2/kddtest_onehot.csv", index=False)