...
def main():
    ...
    test_file_path = "./data_3/kddtest_huffman.csv"
    ...
    # draw.draw_confusion_matrix(test_labels, knn_pred, label_name=['dos','normal', 'probe','r2l','u2r'], title="KNN Confusion Matrix", pdf_save_path="knn_confusion_matrix.png", dpi=300)
    ...
    # draw.draw_confusion_matrix(test_labels, lr_pred, label_name=['dos','normal', 'probe','r2l','u2r'], title="LR Confusion Matrix", pdf_save_path="lr_confusion_matrix.png", dpi=300)
    ...
    draw.draw_confusion_matrix(test_labels, rf_pred, label_name=['dos','normal', 'probe','r2l','u2r'], title="RF Confusion Matrix", pdf_save_path="rf_confusion_matrix.png", dpi=300)
